jQuery("#simulation")
  .on("click", ".s-e6674634-79a3-46a2-88a4-a37252ee1aa6 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/b22f84c2-af77-4e3b-bb80-7ff14ea17a71",
                    "transition": "slideleft"
                  }
                }
              ]
  ...
  .on("pageload", ".s-e6674634-79a3-46a2-88a4-a37252ee1aa6 .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("pageunload", ".s-e6674634-79a3-46a2-88a4-a37252ee1aa6 .pageunload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
